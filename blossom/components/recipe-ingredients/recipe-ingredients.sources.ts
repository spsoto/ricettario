...
export const recipeIngredientByRecipeId: BatchFunction<
  string,
  Maybe<unknown>,
  RequestContext
> = async function recipeIngredientByRecipeId(recipeIds) {
  // Here you are receiving an array of scalars used as IDs. You're expected to
  // return an array where the position "n" of the array contains the entity
  // associated to the ID of the position "n" of the array, otherwise null.
  //
...
export const recipeIngredientByIngredientId: BatchFunction<
  string,
  Maybe<unknown>,
  RequestContext
> = async function recipeIngredientByIngredientId(ingredientIds) {
  // Here you are receiving an array of scalars used as IDs. You're expected to
  // return an array where the position "n" of the array contains the entity
  // associated to the ID of the position "n" of the array, otherwise null.
  //
